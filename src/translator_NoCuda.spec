...
"""
Glossarion Heavy v4.2.0 - PyInstaller Specification File
...
APP_NAME = 'N_Glossarion_NoCuda v4.2.0'  # CHANGED: Updated version
...
excludes = [
	...
	# Core CUDA libraries
    'cuda', 'cuda.*',
    'cudart', 'cudart.*', 'cudart64_*',
    'cublas', 'cublas.*', 'cublas64_*',
    'cublasLt', 'cublasLt.*', 'cublasLt64_*',
    'cudnn', 'cudnn.*', 'cudnn64_*',
    'cufft', 'cufft.*', 'cufft64_*',
    'curand', 'curand.*', 'curand64_*',
    'cusparse', 'cusparse.*', 'cusparse64_*',
    'cusolver', 'cusolver.*', 'cusolver64_*',
    'nvrtc', 'nvrtc.*', 'nvrtc64_*',
    'nvjitlink', 'nvjitlink.*', 'nvJitLink_*',
