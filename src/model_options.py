...
def _get_static_model_options() -> List[str]:
    return [
        ...
        "gpt-6-luna","gpt-6-sol","gpt-6-astra","gpt-5.6-luna","gpt-5.6-sol","gpt-5.6-terra","gpt-5.5","gpt-5.4", "gpt-5.4-pro",
        ...
        # AuthArena – Arena browser-session proxy (names verified against the polled catalog)
        "autharena/gpt-6-astra-low",
        "autharena/gpt-6-astra-medium",
        "autharena/gpt-6-astra-high",
        "autharena/gpt-6-astra-max",
        "autharena/gpt-5.6-luna-low",
        "autharena/gpt-5.6-luna-medium",
        "autharena/gpt-5.6-luna-xhigh",
        "autharena/gpt-5.6-luna-max",
        "autharena/gpt-5.6-sol-low",
        "autharena/gpt-5.6-sol-medium",
        "autharena/gpt-5.6-sol-xhigh",
        "autharena/gpt-5.6-sol-max",
        "autharena/gpt-5.6-sol-search-xhigh",
        "autharena/gpt-5.6-terra-low",
        "autharena/gpt-5.6-terra-medium",
        "autharena/gpt-5.6-terra-xhigh",
        "autharena/gpt-5.6-terra-max",
        "autharena/claude-sonnet-4-6",
        "autharena/claude-sonnet-5",
        "autharena/claude-opus-4-7",
        "autharena/claude-opus-4-7-thinking",
        "autharena/deepseek-v4-pro",
        "autharena/deepseek-v4-pro-low",
        "autharena/deepseek-v4-pro-high",
        "autharena/deepseek-v4-pro-max",
        "autharena/deepseek-v4-flash",
        "autharena/deepseek-v4-flash-max",
        "autharena/gemini-3.1-pro-preview",
        "autharena/gemini-3.5-flash",
        "autharena/gemini-3.7-flash",
        "autharena/gemini-3.8-flash-high",
        "autharena/kimi-k3",
        "autharena/kimi-k2.7-code",
        "autharena/kimi-k2.6",
        "autharena/kimi-k2-thinking-turbo",
        "autharena/glm-5.2",
        ...
        # Opera "Ask AI" (Aria) backend route (no API key; auto-mints token via installed Opera)
        "search/opera",
