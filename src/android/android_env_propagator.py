...
def set_all_env_vars(config):
    ...
    os.environ['COMPRESS_GLOSSARY_MULTIPASS_EXCLUDE_MATCHING'] = '1' if _get('compress_glossary_multipass_exclude_matching', True) else '0'
    ...
    os.environ['ENABLE_UNIFIED_GLOSSARY'] = '1' if _get('enable_unified_glossary', False) else '0'
