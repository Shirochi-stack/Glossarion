...
requirements = python3,kivy==2.3.1,kivymd==1.2.0,pillow,beautifulsoup4,requests,certifi,charset-normalizer,chardet,html2text,tqdm,plyer,pyjnius,six,setuptools,filetype
