...
SPEC_APP_NAMES = {
    ...
    "translator_linux.spec": f"Glossarion_{VERSION_TAG}_Linux",
    "translator_linux_NoCuda.spec": f"N_Glossarion_NoCuda_{VERSION_TAG}_Linux",
    "translator_linux_TurboLite.spec": f"L_Glossarion_TurboLite_{VERSION_TAG}_Linux",
