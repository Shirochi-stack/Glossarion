...
# Models that do not require an API key — delegates to UnifiedClient's authoritative list
...
class GlossarionWeb:
    ...
    def __init__(self):
        ...
        if 'batching_mode' not in self.config:
            ...
            self.decrypted_config['batching_mode'] = 'direct'
    ...
    def set_all_environment_variables(self):
        ...
        batching_mode = config('batching_mode', 'direct')
        ...
        os.environ['COMPRESS_GLOSSARY_STRICT_MATCHING_MODE'] = str(config('compress_glossary_strict_matching_mode', 'all') or 'all')
        ...
        os.environ['COMPRESS_GLOSSARY_MULTIPASS_EXCLUDE_MATCHING'] = '1' if config('compress_glossary_multipass_exclude_matching', True) else '0'
    ...
    def translate_manga(
        ...
        try:
            ...
            os.environ['BATCHING_MODE'] = str(merged_config.get('batching_mode', 'direct'))
