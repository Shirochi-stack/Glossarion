...
COMMON_WORDS = {
    ...
    '一', '二', '三', '四', '五', '六', '七', '八', '九', '十',
    '1', '2', '3', '4', '5', '6', '7', '8', '9', '0',
    # Additional common Chinese function words
    '就', '都', '也', '还', '又', '再', '更', '很', '太', '最',
    '把', '被', '给', '让', '叫', '使', '得', '着', '过', '来', '去',
    '上', '下', '里', '中', '内', '外', '前', '后', '左', '右',
    '这样', '那样', '怎么', '什么', '为什么', '哪里', '谁',
    '可以', '能', '会', '要', '想', '应该', '必须', '可能',
    '不', '没', '别', '莫', '未', '非', '无', '毋',
    '说', '道', '话', '问', '答', '看', '见', '听', '想', '知道',
    '这里', '那里', '哪儿', '这儿', '那儿', '到处', '处处', '各处',
    '然后', '接着', '于是', '因此', '所以', '但是', '可是', '不过',
    '虽然', '尽管', '即使', '如果', '要是', '假如', '无论', '不管',
    '只', '仅', '才', '刚', '正', '在', '将', '已', '曾', '曾经',
}
