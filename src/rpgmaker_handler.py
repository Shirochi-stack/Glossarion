...
_GTOOL_PLUGIN_JS = """\
/*:
 * @plugindesc GTool Translation Font Patch - Auto-generated by Glossarion
 * @author Glossarion GTool
 *
 * @help Overrides font size for translated text. Edit settings.json in
 * GTool_Translation folder to change fontSize.
 * Do NOT delete this file while using the translation.
 */
(function() {
    var fs = require('fs');
...
def _apply_gtool_settings(data_dir: str, gtool_dir: str, log: Callable):
    ...
    with open(plugin_path, 'w', encoding='utf-8') as f:
        f.write(_GTOOL_PLUGIN_JS % font_size)
