...
"""
Glossarion v8.5.5 - PyInstaller Specification File
...
APP_NAME = 'Glossarion v8.5.5'  # CHANGED: Updated version
...
a.binaries = [b for b in a.binaries if not any([
    ...
    'scipy.libs' in b[0],
    'onnxruntime_extensions' in b[0],
    'libscipy_openblas' in b[0].lower(),
    'onnxruntime_extensions' in b[0],
    'libscipy_openblas' in b[0].lower(),
    '_avif' in b[0],
    'pypdfium' in b[0],
