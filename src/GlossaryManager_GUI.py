...
class GlossaryManagerMixin:
    ...
    def _setup_manual_glossary_tab(self, parent):
        ...
        placeholders_line.setToolTip(
            "<qt><table width='600' style='font-size:9pt;' cellpadding='2'>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{fields}</b></td>"
            "<td style='word-wrap:break-word;'>comma-separated columns/entry types list</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{fields1}</b></td>"
            "<td style='word-wrap:break-word;'>\\x1F-separated columns/entry types list (recommended)</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{language}</b></td>"
            "<td style='word-wrap:break-word;'>target language</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{entries}</b></td>"
            "<td style='word-wrap:break-word;'>enabled custom entry types (comma list with ampersand)</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_mandatory}</b></td>"
            "<td style='word-wrap:break-word;'><i>'The description column is mandatory and must be detailed'</i>"
            "<br/>Active when 'description' in Custom Fields; stripped otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_detailed}</b></td>"
            "<td style='word-wrap:break-word;'><i>'The description column must contain detailed context/explanation'</i>"
            "<br/>Active when 'description' in Custom Fields; stripped otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_in_language}</b></td>"
            "<td style='word-wrap:break-word;'><i>' and description'</i> (inline append)"
            "<br/>Active when 'description' in Custom Fields; blank otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_excluded_note}</b></td>"
            "<td style='word-wrap:break-word;'><i>' (The description column is excluded from this restriction)'</i>"
            "<br/>Active when 'description' in Custom Fields; blank otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_example}</b></td>"
            "<td style='word-wrap:break-word;'><i>'For example:<br/>"
            "&nbsp;&nbsp;character,이히리ᐐ 나애,Dihirit Ade,female,\"description...\"<br/>"
            "&nbsp;&nbsp;character,뢤사난,Kim Sang-hyu,male,\"description...\"'</i>"
            "<br/>Active when 'description' in Custom Fields; stripped otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{example}</b></td>"
            "<td style='word-wrap:break-word;'><i>'For example:<br/>"
            ...
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_name_split_example}</b></td>"
            "<td style='word-wrap:break-word;'><i>'For character entries, the raw_name must contain ONLY the given name (first name), never a full name. "
            ...
            "<br/>Active when 'description' in Custom Fields; stripped otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{name_split_example}</b></td>"
            "<td style='word-wrap:break-word;'><i>'For character entries, the raw_name must contain ONLY the given name (first name), never a full name. "
            "If the text mentions a character by full name (e.g. &quot;김상현&quot;), split it: create one entry with raw_name &quot;상현&quot; "
            "(given name) and a second entry with raw_name &quot;김&quot; (surname). Example output:<br/>"
            ...
            "&nbsp;&nbsp;Do NOT create a single combined full-name entry (e.g. character,김상현,Kim Sang-hyun,male) — always split into given name + surname.'</i>"
            "<br/>Active when 'description' NOT in Custom Fields; stripped otherwise</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{gender_instruction}</b></td>"
            "<td style='word-wrap:break-word;'><i>'The gender column applies only to [types] entries — "
...
{translation_prompt}"""
    ...
    def _setup_auto_glossary_tab(self, parent):
        ...
        placeholder_line.setToolTip(
            ...
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{entries}</b></td>"
            "<td style='word-wrap:break-word;'>enabled custom entry types (comma list with ampersand)</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{min_frequency}</b></td>"
            "<td style='word-wrap:break-word;'>minimum term frequency</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{max_names}</b></td>"
            "<td style='word-wrap:break-word;'>max character names</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{max_titles}</b></td>"
            "<td style='word-wrap:break-word;'>max titles</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{marker}</b></td>"
            "<td style='word-wrap:break-word;'>context window marker count</td></tr>"
            "<tr><td style='white-space:nowrap; vertical-align:top;'><b>{description_example}</b></td>"
            "<td style='word-wrap:break-word;'><i>'For example:<br/>"
            "&nbsp;&nbsp;character,이히리ᐐ 나애,Dihirit Ade,female,\"description...\"<br/>"
            "&nbsp;&nbsp;character,뢤사난,Kim Sang-hyu,male,\"description...\"'</i>"
