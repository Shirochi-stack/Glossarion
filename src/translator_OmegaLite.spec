...
APP_NAME = 'L_Glossarion_OmegaLite v8.5.4'  # OmegaLite: no EPUB reader / Chromium
...
excludes = [
    ...
    # ============================================================================
    # VERTEX AI / GOOGLE CLOUD AIPLATFORM - OmegaLite: intentionally excluded
...
a.pure = [p for p in a.pure if not any([
    ...
    # ---- OmegaLite: strip entire Vertex AI / aiplatform stack (~60 MB) ----
    # Most users don't use Vertex Model Garden on OmegaLite.
