...
def gui_methods():
    ...
    names = {'_refresh_auth_account_arrows', '_get_authgpt_account_id', '_authgpt_pool_route_requested', '_authgem_vertex_control_model', '_get_authgem_account_id', '_update_authgem_login_status'}
